package com.travelapp.util.custom
...
import com.travelapp.ui.Albums
...
class ImageFolder {
    ...
    private fun getListOfVideoFolders(activity: Activity, albumsList: ArrayList<Albums>): ArrayList<Albums> {
        ...
        cursor =
            activity.contentResolver.query(uri, projection1, BUCKET_GROUP_BY, null, BUCKET_ORDER_BY)!!
